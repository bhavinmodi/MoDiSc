 ...
 */
public class SendDataToServerMaster extends AsyncTask<JSONObject, String, Integer>{

	private Context context;
	private OnTaskCompleted listener;
	
	public SendDataToServerMaster(Context context, OnTaskCompleted listener){
	...
	protected Integer doInBackground(JSONObject... params) {
		...
		try{
			URL url = new URL("http://modisc.dx.am/Jpost.php");
