 ...
 */
public class AskUpdateFromServerMaster extends AsyncTask<JSONObject, String, JSONObject>{

	private Context context;
	private OnReceiveUpdates listener;
	
	public AskUpdateFromServerMaster(Context context, OnReceiveUpdates listener){
	...
	protected JSONObject doInBackground(JSONObject... params) {
		...
		try{
			URL url = new URL("http://modisc.dx.am/JrequestUpdate.php");
		    ...
		    Log.println(Log.ASSERT, "AskUpdateFromServer", "Response: "+sResponse);
